...
@Tag(
        ...
        description = "CRUD REST APIs for Customers in EazyBank to CREATE, UPDATE, FETCH and DELETE accounts details"
)
@RestController
...
public class CustomerController {
    ...
    @Operation(
            summary = "Fetch customer details Rest API in EazyBank",
    ...
    public ResponseEntity<CustomerDetailsDto> fetchCustomerDetails(@RequestHeader("eazybank-correlation-id") String correlationId,
                                                                   ...
                                                                   String mobileNumber) {
        logger.debug("eazyBank-correlation-id found in fetchCustomerDetails: {}", correlationId);
